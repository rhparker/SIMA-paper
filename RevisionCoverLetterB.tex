...
We added a note about how $n\ge2$ can be reformulated as an $n=1$ problem.
...
This is now explained on line 364.
...
In line 423, we now explain that $c$ is a free parameter typically representing the wavespeed. In line 438, we define the zero-amplitude wavespeed $c_0$.
...
This is now explained starting on line 493. An appropriate reference is cited.
...
$A_0$ is now defined on line 653.
...
It is our own numerical evidence. We added text to make that clear.
...
Theorem 6.6 (formerly Theorem 6.4) states that the bounds for $r$ and $w_j$ hold for all derivatives with respect to $x$. As recommended by the reviewer, we have added the particular case of $||\partial_x w||_\infty$, since that result is used later.
...
An explanation of this can now be found in the paragraph before the statement of Lemma 6.11.
...
We have added several sentences to this effect at the beginning of Section 5.
